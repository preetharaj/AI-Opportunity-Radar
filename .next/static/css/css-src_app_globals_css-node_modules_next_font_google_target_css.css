...
.bg-\[radial-gradient\(circle_at_top_left\2c rgba\(79\2c 70\2c 229\2c 0\.16\)\2c transparent_34\%\)\2c radial-gradient\(circle_at_85\%_15\%\2c rgba\(14\2c 165\2c 233\2c 0\.14\)\2c transparent_30\%\)\] {
  background-image: radial-gradient(circle at top left,rgba(79,70,229,0.16),transparent 34%),radial-gradient(circle at 85% 15%,rgba(14,165,233,0.14),transparent 30%);
}
.bg-gradient-to-br {
